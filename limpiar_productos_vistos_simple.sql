-- Script simple para limpiar productos vistos duplicados
...
WITH productos_vistos_consolidados AS (
    SELECT 
        usuario_id,
        producto_id,
    ...
    GROUP BY usuario_id, producto_id, metadata
)
...
-- 4. Mostrar algunos ejemplos de productos vistos consolidados
SELECT 
    usuario_id,
    producto_id,
    tiempo_vista,
...
-- 5. Mostrar estadísticas de tiempo de vista consolidado
SELECT 
