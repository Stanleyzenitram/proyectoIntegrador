...
export default function CartItem({ item }: CartItemProps) {
    ...
    return (
        <>
            <div className="grid grid-cols-5 items-center py-2 border-b gap-3 text-sm">
                {/* PRODUCTO */}
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="font-medium text-sm">{item.nombre_producto}</h3>
                ...
                <div className="text-center">
                    <div className="flex items-center justify-center gap-1">
                        ...
                        <span className="text-xs">{getDisplayQuantity()}</span>
                        <button
                            onClick={() => handleQuantityChange(item.quantity + 1)}
                            className="px-1.5 py-0.5 bg-gray-100 hover:bg-gray-200 rounded text-xs"
