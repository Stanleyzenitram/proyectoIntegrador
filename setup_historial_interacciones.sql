...
CREATE TABLE IF NOT EXISTS historial_productos_vistos (
    ...
    tiempo_vista INTEGER DEFAULT 0, -- tiempo en segundos
    relevancia_calculada INTEGER DEFAULT 0, -- porcentaje de relevancia
    metadata JSONB DEFAULT '{}'::jsonb -- datos adicionales como categoría, precio, etc.
);
...
CREATE TABLE IF NOT EXISTS historial_busquedas (
    ...
    filtros_aplicados JSONB DEFAULT '{}'::jsonb, -- filtros usados en la búsqueda
...
CREATE TABLE IF NOT EXISTS historial_compras (
    ...
    orden_id TEXT, -- ID de la orden/pedido
...
CREATE TABLE IF NOT EXISTS historial_clics (
    ...
    tipo_clic TEXT DEFAULT 'producto', -- 'producto', 'categoria', 'filtro', etc.
    origen_clic TEXT, -- desde dónde vino el clic
...
BEGIN
    ...
    -- No eliminar compras, solo productos vistos, búsquedas y clics
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    SELECT 
        ...
        stats.clics,
        conversion.tasa,
        'Baño'::TEXT, -- Placeholder, se puede mejorar con consulta real
        '$100-$200'::TEXT -- Placeholder, se puede mejorar con consulta real
    FROM stats, conversion;
END;
$$ LANGUAGE plpgsql;

-- Nota: Para insertar datos de ejemplo, reemplaza 'tu-user-id-aqui' con un UUID válido
-- de un usuario existente en tu base de datos.
