...
DROP POLICY IF EXISTS "Usuarios pueden ver su propio historial de productos vistos" ON historial_productos_vistos;
DROP POLICY IF EXISTS "Usuarios pueden insertar su propio historial de productos vistos" ON historial_productos_vistos;
DROP POLICY IF EXISTS "Usuarios pueden actualizar su propio historial de productos vistos" ON historial_productos_vistos;
DROP POLICY IF EXISTS "Usuarios pueden eliminar su propio historial de productos vistos" ON historial_productos_vistos;

DROP POLICY IF EXISTS "Usuarios pueden ver su propio historial de búsquedas" ON historial_busquedas;
DROP POLICY IF EXISTS "Usuarios pueden insertar su propio historial de búsquedas" ON historial_busquedas;
DROP POLICY IF EXISTS "Usuarios pueden actualizar su propio historial de búsquedas" ON historial_busquedas;
DROP POLICY IF EXISTS "Usuarios pueden eliminar su propio historial de búsquedas" ON historial_busquedas;

DROP POLICY IF EXISTS "Usuarios pueden ver su propio historial de compras" ON historial_compras;
DROP POLICY IF EXISTS "Usuarios pueden insertar su propio historial de compras" ON historial_compras;
DROP POLICY IF EXISTS "Usuarios pueden actualizar su propio historial de compras" ON historial_compras;
DROP POLICY IF EXISTS "Usuarios pueden eliminar su propio historial de compras" ON historial_compras;

DROP POLICY IF EXISTS "Usuarios pueden ver su propio historial de clics" ON historial_clics;
DROP POLICY IF EXISTS "Usuarios pueden insertar su propio historial de clics" ON historial_clics;
DROP POLICY IF EXISTS "Usuarios pueden actualizar su propio historial de clics" ON historial_clics;
DROP POLICY IF EXISTS "Usuarios pueden eliminar su propio historial de clics" ON historial_clics;
