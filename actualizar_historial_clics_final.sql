-- Script final para actualizar la tabla historial_clics para evitar duplicados
...
-- Usar ROW_NUMBER para obtener el metadata del registro más reciente
WITH ranked_clics AS (
    SELECT 
        *,
        ROW_NUMBER() OVER (
...
clics_consolidados AS (
    SELECT 
        ...
        -- Tomar el metadata del primer registro (el más reciente)
