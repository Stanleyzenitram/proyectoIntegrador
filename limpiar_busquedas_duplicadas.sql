-- Script para limpiar búsquedas duplicadas existentes
...
SELECT DISTINCT ON (usuario_id, LOWER(termino_busqueda))
    id,
    usuario_id,
    LOWER(termino_busqueda) as termino_normalizado,
    termino_busqueda,
...
-- CREATE TABLE historial_busquedas_backup AS SELECT * FROM historial_busquedas;

-- 4. Limpiar la tabla original
DELETE FROM historial_busquedas;

-- 5. Reinsertar solo las búsquedas únicas
...
-- 7. Mostrar algunos ejemplos de búsquedas únicas
SELECT 
    usuario_id,
    termino_busqueda,
    fecha_busqueda,
...
-- 8. Crear índice para mejorar el rendimiento de búsquedas únicas
