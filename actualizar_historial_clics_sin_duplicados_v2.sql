-- Script para actualizar la tabla historial_clics para evitar duplicados (Versión 2)
...
-- Primero, crear una tabla temporal con los datos consolidados
CREATE TEMP TABLE clics_consolidados AS
SELECT 
    usuario_id,
    producto_id,
    tipo_clic,
    ...
    -- Tomar el metadata del registro más reciente
    (SELECT metadata FROM historial_clics h2 
